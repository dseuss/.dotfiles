...
nnoremap <silent> <leader>ic :py if update_subchannel_msgs(force=True): echo("vim-ipython shell updated",'Operator')<CR>
nnoremap <silent> <leader>is :python dedent_run_this_line()<CR>
vnoremap <silent> <leader>is :python dedent_run_these_lines()<CR>
