...
# JupyterWidget will inherit config from: BaseIPythonApplication,
# Application, IPythonConsoleApp, ConnectionFileMixin

# Set the kernel's IP address [default localhost]. If the IP address is
# something other than localhost, then Consoles on other machines will be able
# to connect to the Kernel, so be careful!
# c.JupyterWidget.ip = u''

# Create a massive crash report when IPython encounters what may be an internal
# error.  The default is to append a short message to the usual traceback
# c.JupyterWidget.verbose_crash = False

# Start the console window maximized.
# c.JupyterWidget.maximize = False

# Whether to install the default config files into the profile dir. If a new
# profile is being created, and IPython contains config files for that profile,
# then they will be staged into the new directory.  Otherwise, default config
# files will be automatically generated.
# c.JupyterWidget.copy_config_files = False

# The date format used by logging formatters for %(asctime)s
# c.JupyterWidget.log_datefmt = '%Y-%m-%d %H:%M:%S'

# set the shell (ROUTER) port [default: random]
# c.JupyterWidget.shell_port = 0

# Whether to create profile dir if it doesn't exist
# c.JupyterWidget.auto_create = False

# The SSH server to use to connect to the kernel.
# c.JupyterWidget.sshserver = ''

# set the stdin (ROUTER) port [default: random]
# c.JupyterWidget.stdin_port = 0

# Set the log level by value or name.
# c.JupyterWidget.log_level = 30

# Path to the ssh key to use for logging in to the ssh server.
# c.JupyterWidget.sshkey = ''

# Path to an extra config file to load.
#
# If specified, load this config file in addition to any other IPython config.
# c.JupyterWidget.extra_config_file = u''

# set the control (ROUTER) port [default: random]
# c.JupyterWidget.control_port = 0

# path to a custom CSS stylesheet
# c.JupyterWidget.stylesheet = ''

# set the heartbeat port [default: random]
# c.JupyterWidget.hb_port = 0

# Whether to overwrite existing config files when copying
# c.JupyterWidget.overwrite = False

# set the iopub (PUB) port [default: random]
# c.JupyterWidget.iopub_port = 0

# The IPython profile to use.
# c.JupyterWidget.profile = u'default'
...
# c.JupyterWidget.connection_file = ''

# Set to display confirmation dialog on exit. You can always use 'exit' or
# 'quit', to force a direct exit without any confirmation.
# c.JupyterWidget.confirm_exit = True

# The name of the IPython directory. This directory is used for logging
# configuration (through profiles), history storage, etc. The default is usually
# $HOME/.ipython. This option can also be specified through the environment
# variable IPYTHONDIR.
# c.JupyterWidget.ipython_dir = u''

# Whether to display a banner upon starting the QtConsole.
# c.JupyterWidget.display_banner = True

# Connect to an already running kernel
# c.JupyterWidget.existing = ''

# Use a plaintext widget instead of rich text (plain can't print/save).
# c.JupyterWidget.plain = False

# Start the console window with the menu bar hidden.
# c.JupyterWidget.hide_menubar = False

# The name of the default kernel to start.
# c.JupyterWidget.kernel_name = 'python'

# The Logging format template
# c.JupyterWidget.log_format = '[%(name)s]%(highlevel)s %(message)s'

#
# c.JupyterWidget.transport = 'tcp'
...
# c.JupyterWidget.lexer_class = <IPython.utils.traitlets.Undefined object at 0x10cc21250>
...
c.JupyterWidget.font_family = u'Anonymous Pro'
