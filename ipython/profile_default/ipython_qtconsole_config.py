...
# variable IPYTHONDIR.
# c.IPythonQtConsoleApp.ipython_dir = u'/home/dsuess/.config/ipython'
...
c.IPythonWidget.editor_line = u'/usr/local/bin/gvim -f'
...
c.IPythonWidget.editor = '/usr/local/bin/gvim -f'
